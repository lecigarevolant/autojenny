...
class MagenticOneGroupChatPlus(BaseGroupChat, Component[MagenticOneGroupChatConfig]):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            participants,
            group_chat_manager_class=MagenticOneOrchestratorPlus,
    ...
    def _create_group_chat_manager_factory(
        ...
        max_turns: int | None,
    ) -> Callable[[], MagenticOneOrchestratorPlus]:
        return lambda: MagenticOneOrchestratorPlus(
            group_topic_type,
            output_topic_type,
